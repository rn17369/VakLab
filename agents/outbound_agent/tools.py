...
def send_enrollment_email(email_address, first_name):
    ...
    Vaklab Preventive Health Screening program.
    """
        ...
        <tr>
            <td align="center" style="padding: 20px 0;">
                <table border="0" cellpadding="0" cellspacing="0" width="600" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; border: 1px solid #dddddd;">
                    ...
                    <tr>
                        <td align="center" style="padding: 20px; background-color: #4A2D82;">
                            <h1 style="color: #ffffff; margin: 0; font-size: 28px;">Vaklab</h1>
                            <p style="font-size: 12px; color: #ffffff; margin-top: 5px;">Health and wellness or prevention information</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 30px 40px; color: #333333; line-height: 1.6;">
                            ...
                            <p style="font-size: 16px;">
                                You’re the glue that holds your circle together—and at <b>Vaklab</b>, that’s why your health matters most to us.
                            </p>
                            <p style="font-size: 16px;">
                    ...
                    <tr>
                        <td align="center" style="padding: 40px; background-color: #4A2D82; color: #ffffff;">
                            ...
                            <p style="font-size: 16px; margin: 10px 0 20px 0;">Your mammogram is covered by your <b>Vaklab plan</b>.</p>
