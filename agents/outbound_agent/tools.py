...
def _get_member_data(phone_number: str, member_id: str = None, campaign_name: str = None):
    ...
    try:
        ...
        if result:
            member_id, member_first_name, member_last_name, member_email, campaign_name, csr_name, csr_phone_number = result
            return {
                "member_id": member_id,
...
def send_enrollment_email(email_address, first_name):
    ...
    Vaklab Better Care Rewards program using inline images.
    """
    subject = "For you, and everyone who counts on you, {first_name}"
...
<body style="margin: 0; padding: 0; background-color: #f4f4f4; font-family: Arial, sans-serif;">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; border: 1px solid #dddddd;">
                    ...
                    <tr>
                        <td align="center" style="padding: 20px;">
                            <img src="cid:logo" alt="Vaklab" width="140" style="display: block; border: 0;">
                    ...
                    <tr>
                        <td align="center" style="padding: 0 20px;">
                            <img src="cid:hero_image" alt="Live Well with Vaklab" width="560" style="display: block; width: 100%; max-width: 560px; border-radius: 15px;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" style="padding: 40px; background-color: #4A2D82; color: #ffffff;">
                            ...
                            <p style="font-size: 16px; margin: 10px 0 20px 0;">Your mammogram is covered by your <b>Vaklab Medicare plan</b>.</p>
    ...
    try:
        ...
        # 3. Attach the Images
        # Note: Ensure 'mjon.jpg' and 'vaklab_logo.png' are in your script's folder
        image_files = [
            ("vaklab_logo.png", "logo"),     # Your logo file
...
def end_call(tool_context: ToolContext):
    ...
    try:
        ...
        logging.info(f"VaklabAgent leaving conversation for Call SID: {call_sid}")
        
        # update state ensuring loop breaks so the AI stops processing audio
        tool_context.state["call_ended"] = True
        
        return "VaklabAgent session ended. Goodbye."
    except Exception as e:
        logging.error(f"Failed to end agent session: {e}")
        tool_context.state["call_ended"] = True
        return "VaklabAgent session ended with error."
